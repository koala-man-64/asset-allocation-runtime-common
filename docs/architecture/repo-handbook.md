...
- A scheduled refresh workflow syncs `main` directly when the contracts pin falls behind, and it fails after the update if validation breaks so fix-forward work starts immediately.
